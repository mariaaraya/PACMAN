...
class Blinky(Fantasma):
    ...
    def mover_hacia_objetivo(self, pacman_posicion, grafo, delta_time):
            ...
            self.modo = "persecucion"



    def colision_Pacman(self):
        """Maneja la colisión con Pac-Man, haciendo que Blinky regrese a su posición inicial y espere 2 segundos."""
        self.posicion_inicial = self.posicion_inicial  # Regresa a la posición de origen
        self.en_colision = True  # Marca que está en colisión
        self.inicio_colision = pygame.time.get_ticks()  # Registra el tiempo de inicio de la espera
